...
class Cell:
    ...
    def __sub__(self, other):
        ...
        if self.count < other.count:
            return f"количество ячеек изначальной клетки меньше, вычитание невозможно."
        else:
    ...
    def __truediv__(self, other):
        new = self.count // other.count
        if new < 1:
            return f"Результат не может быть меньше единицы."
        else:
            return new

    def make_oder(self, num):
        z = self.count // num
        dev = self.count - z * num
        result_z = num * "*"
        result_dev = dev * "*"
        return (result_z + "\n") * z + result_dev
...
print(cell_1 * cell_2)
print(cell_1 / cell_2)
print(cell_1.make_oder(3))
print(cell_2.make_oder(2))
